...
public class TestingAllCS : MonoBehaviour
{
	...
	public void updateValueExample()
	{
		...
		pass.Add("message", "hi");
		LeanTween.valueObject( gameObject, (Action<float, object>) updateValueExampleCallback, ltLogo.transform.eulerAngles.y, 270f, 1f ).setEase(LeanTweenType.easeOutElastic).setOnUpdateParam(pass).setUseEstimatedTime(useEstimatedTime);
	}
